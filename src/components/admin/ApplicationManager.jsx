  ...
  return (
    <div className="space-y-4 md:space-y-6">
      ...
      {showDeleteModal && applicationToDelete && (
        <div className="fixed inset-0 bg-gray-700/40 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg shadow-xl w-full max-w-md border border-gray-200">
            <div className="p-4 md:p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="text-base md:text-lg font-bold text-gray-900">Delete Application</h3>
              ...
              <div className="bg-gray-50 p-3 md:p-4 rounded-lg mb-4 md:mb-6">
                <p className="text-xs md:text-sm text-gray-700 mb-2">Are you sure you want to delete the application from:</p>
                <p className="font-semibold text-sm md:text-base text-gray-900 break-words">{applicationToDelete.organization_name}</p>
                <p className="text-xs md:text-sm text-gray-600 mt-1">Contact: {applicationToDelete.contact_person}</p>
              </div>
